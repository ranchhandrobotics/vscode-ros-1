...
| Name | Description |
|---|:---|
| [Attaching to a running ROS Node](https://github.com/ranchhandrobotics/rde-ros-1/blob/master/doc/debug-support.md) | Learn how to attach VS Code to a running ROS node |
| [Debugging all ROS Nodes in a launch file ](https://github.com/ranchhandrobotics/rde-ros-1/blob/master/doc/debug-support.md) | Learn how to set up VS Code to debug the nodes in a ROS Launch file |
